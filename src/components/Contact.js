...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap" netlify-recaptcha>
        <form
          data-netlify="true"
          ...
          <p className="leading-relaxed mb-5">
            If you find my portfolio interesting and want to work with me then feel free to fill out this form with your contact information and I will get back to you as soon as possible. Thank you for your time!
          </p>
          ...
          <button
            type="submit"
            className="text-black bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
            Submit
          </button>
        </form>
      </div>
